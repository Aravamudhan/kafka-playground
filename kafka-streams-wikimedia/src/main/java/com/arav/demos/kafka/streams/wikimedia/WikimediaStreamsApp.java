package com.arav.demos.kafka.streams.wikimedia;

import com.arav.demos.kafka.streams.wikimedia.processor.BotCountStreamBuilder;
import com.arav.demos.kafka.streams.wikimedia.processor.EventCountTimeseriesBuilder;
import com.arav.demos.kafka.streams.wikimedia.processor.WebsiteCountStreamBuilder;
...
public class WikimediaStreamsApp {
    ...
    static {
        ...
        properties.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "127.0.0.1:9001");
